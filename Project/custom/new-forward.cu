...
__global__ void conv_forward_kernel(float * __restrict__ output, const float * __restrict__ input, const float * __restrict__ mask, const int B, const int M, const int C, const int H, const int W, const int K,const int S)
{
    ...
    */
    ...
    for (int c=0; c<C; c++) {
        ...
        //         /* 2 by 2 */
        //         if (kr < K && kc < K)
        //             pValue += in_2d(ty*S+kr, tx*S+kc) * mask_4d(m, c, kr, kc);
        //         if (kr < K && kc+1 < K)
        //             pValue += in_2d(ty*S+kr, tx*S+kc+1) * mask_4d(m, c, kr, kc+1);
        //         if (kr+1 < K && kc < K)
        //             pValue += in_2d(ty*S+kr+1, tx*S+kc) * mask_4d(m, c, kr+1, kc);
        //         if (kr+1 < K && kc+1 < K)
        //             pValue += in_2d(ty*S+kr+1, tx*S+kc+1) * mask_4d(m, c, kr+1, kc+1);
        //     }
        // }
        pValue += in_2d(ty*S+0, tx*S+0) * mask_4d(m, c, 0, 0);
        pValue += in_2d(ty*S+0, tx*S+1) * mask_4d(m, c, 0, 1);
        pValue += in_2d(ty*S+0, tx*S+2) * mask_4d(m, c, 0, 2);

        pValue += in_2d(ty*S+1, tx*S+0) * mask_4d(m, c, 1, 0);
        pValue += in_2d(ty*S+1, tx*S+1) * mask_4d(m, c, 1, 1);
        pValue += in_2d(ty*S+1, tx*S+2) * mask_4d(m, c, 1, 2);

        pValue += in_2d(ty*S+2, tx*S+0) * mask_4d(m, c, 2, 0);
        pValue += in_2d(ty*S+2, tx*S+1) * mask_4d(m, c, 2, 1);
        pValue += in_2d(ty*S+2, tx*S+2) * mask_4d(m, c, 2, 2);
        if (K == 7) {
            pValue += in_2d(ty*S+0, tx*S+3) * mask_4d(m, c, 0, 3);
            pValue += in_2d(ty*S+0, tx*S+4) * mask_4d(m, c, 0, 4);
            pValue += in_2d(ty*S+0, tx*S+5) * mask_4d(m, c, 0, 5);
            pValue += in_2d(ty*S+0, tx*S+6) * mask_4d(m, c, 0, 6);
    
            pValue += in_2d(ty*S+1, tx*S+3) * mask_4d(m, c, 1, 3);
            pValue += in_2d(ty*S+1, tx*S+4) * mask_4d(m, c, 1, 4);
            pValue += in_2d(ty*S+1, tx*S+5) * mask_4d(m, c, 1, 5);
            pValue += in_2d(ty*S+1, tx*S+6) * mask_4d(m, c, 1, 6);
    
            pValue += in_2d(ty*S+2, tx*S+3) * mask_4d(m, c, 2, 3);
            pValue += in_2d(ty*S+2, tx*S+4) * mask_4d(m, c, 2, 4);
            pValue += in_2d(ty*S+2, tx*S+5) * mask_4d(m, c, 2, 5);
            pValue += in_2d(ty*S+2, tx*S+6) * mask_4d(m, c, 2, 6);
    
            pValue += in_2d(ty*S+3, tx*S+0) * mask_4d(m, c, 3, 0);
            pValue += in_2d(ty*S+3, tx*S+1) * mask_4d(m, c, 3, 1);
            pValue += in_2d(ty*S+3, tx*S+2) * mask_4d(m, c, 3, 2);
            pValue += in_2d(ty*S+3, tx*S+3) * mask_4d(m, c, 3, 3);
            pValue += in_2d(ty*S+3, tx*S+4) * mask_4d(m, c, 3, 4);
            pValue += in_2d(ty*S+3, tx*S+5) * mask_4d(m, c, 3, 5);
            pValue += in_2d(ty*S+3, tx*S+6) * mask_4d(m, c, 3, 6);
    
            pValue += in_2d(ty*S+4, tx*S+0) * mask_4d(m, c, 4, 0);
            pValue += in_2d(ty*S+4, tx*S+1) * mask_4d(m, c, 4, 1);
            pValue += in_2d(ty*S+4, tx*S+2) * mask_4d(m, c, 4, 2);
            pValue += in_2d(ty*S+4, tx*S+3) * mask_4d(m, c, 4, 3);
            pValue += in_2d(ty*S+4, tx*S+4) * mask_4d(m, c, 4, 4);
            pValue += in_2d(ty*S+4, tx*S+5) * mask_4d(m, c, 4, 5);
            pValue += in_2d(ty*S+4, tx*S+6) * mask_4d(m, c, 4, 6);
    
            pValue += in_2d(ty*S+5, tx*S+0) * mask_4d(m, c, 5, 0);
            pValue += in_2d(ty*S+5, tx*S+1) * mask_4d(m, c, 5, 1);
            pValue += in_2d(ty*S+5, tx*S+2) * mask_4d(m, c, 5, 2);
            pValue += in_2d(ty*S+5, tx*S+3) * mask_4d(m, c, 5, 3);
            pValue += in_2d(ty*S+5, tx*S+4) * mask_4d(m, c, 5, 4);
            pValue += in_2d(ty*S+5, tx*S+5) * mask_4d(m, c, 5, 5);
            pValue += in_2d(ty*S+5, tx*S+6) * mask_4d(m, c, 5, 6);
    
            pValue += in_2d(ty*S+6, tx*S+0) * mask_4d(m, c, 6, 0);
            pValue += in_2d(ty*S+6, tx*S+1) * mask_4d(m, c, 6, 1);
            pValue += in_2d(ty*S+6, tx*S+2) * mask_4d(m, c, 6, 2);
            pValue += in_2d(ty*S+6, tx*S+3) * mask_4d(m, c, 6, 3);
            pValue += in_2d(ty*S+6, tx*S+4) * mask_4d(m, c, 6, 4);
            pValue += in_2d(ty*S+6, tx*S+5) * mask_4d(m, c, 6, 5);
            pValue += in_2d(ty*S+6, tx*S+6) * mask_4d(m, c, 6, 6);
        } 
        __syncthreads();
    }
